...
const menuItems: MenuItem[] = [
  ...
  { icon: Users, label: "Care Team", path: "/workspace" },
];
    ...
    <>
      <div className="relative" ref={sidebarRef}>
        ...
        >
          ...
          <SidebarFooter className="p-3 flex items-center justify-between gap-2 border-t border-border">
            <ProfileDropdownMenu align="start" className="flex-1" />
